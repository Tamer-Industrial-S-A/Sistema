...
export const ProyectoManager: React.FC<ProyectoManagerProps> = ({ data, onDataUpdate }) => {
  ...
  const handleSyncWithMaterials = () => {
    ...
    // Fix: Ensure imprevistos is a number for arithmetic operation
    const currentImprevistos = Number(selectedQuote.IMPREVISTOS) || 0;
    const total = subtotalNeto * (1 + currentImprevistos / 100);
